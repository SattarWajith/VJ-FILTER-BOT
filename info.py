...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sattar-wajith:F1I2S3T4A5@cluster0.demdt.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
